...
namespace NN.Native.Operators.X86.Arithmetic
{
    ...
    public class SubtractOperator<T> : ISubtractOperator<T> where T : unmanaged, IAdditionOperators<T, T, T>, INumberBase<T>
    {
...
#else
    public class SubtractOperator<T, THandler>: ISubtractOperator<T> where T : unmanaged where THandler: INativeDTypeHandler<T>, new()
    {
        ...
        {
            var res = new NativeArray<T>(ISubtractOperator<T>.DeduceLayout(a._layout, b._layout), memoryManager);
        ...
        {
            var res = new NativeArray<T>(ISubtractOperator<T>.DeduceLayout(a._layout), memoryManager);
        ...
        {
            var res = new NativeArray<T>(ISubtractOperator<T>.DeduceLayout(b._layout), memoryManager);
