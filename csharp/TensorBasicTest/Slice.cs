...
public class SliceTest
{
    ...
    public void Test1()
    {
        ...
        Tensor truth = Tensor.FromArray(new int[] { 6, 1, 2, 2, 3, 4 }, new int[] { 2, 3 });
    ...
    public void Test2()
    {
        ...
        Tensor truth = Tensor.FromArray(new int[] { 2, 5, 2, 6, 3, 6 }, new int[] { 2, 3 });
        Assert.IsTrue(TensorUtils.IsValueEqual(dst, truth));
    }
    ...
    public void Test3()
    {
        ...
        Tensor truth = Tensor.FromArray(new int[] { 2, 4 }, new int[] { 2 });
        Assert.IsTrue(TensorUtils.IsValueEqual(dst, truth));
    }
}